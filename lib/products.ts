...
// To get the actual file IDs:
// 1. Go to the Google Drive folder: https://drive.google.com/drive/folders/19xMSHqFGMeaJTtmV8Jud4cxt4_IijZ_o?usp=sharing
// 2. Right-click each image file and select "Get shareable link"
// 3. Extract the file ID from the URL (the part between /d/ and /view)
// 4. Replace the placeholder IDs below with the actual file IDs
